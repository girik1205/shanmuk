                        ...
                        <li>
                         ...
                         <li>
                           ...
                           <a href="<?=$basepath?>branches"  class="<?=$_REQUEST['page']=='branches'?'active':''?>"><i class="fa fa-home fa-fw"></i> Branches</a>
                            ...
                            <li>
                           <a href="<?=$basepath?>about"  class="<?=$_REQUEST['page']=='about'?'active':''?>"><i class="fa fa-home fa-fw"></i> About Page</a>
                           </li>
                           <li>
                           <a href="<?=$basepath?>galleries"  class="<?=$_REQUEST['page']=='galleries'?'active':''?>"><i class="fa fa-home fa-fw"></i> Gallery</a>
                           </li>
                          <li>
                           <a href="<?=$basepath?>careers"  class="<?=$_REQUEST['page']=='careers'?'active':''?>"><i class="fa fa-home fa-fw"></i> Careers</a>
                           </li>
